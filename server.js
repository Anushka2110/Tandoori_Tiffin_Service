...
app.use(session({
  ...
  secret: 'Tiffin',  //Dabbawala
  store: new MongoStore({ url: 'mongodb://college1:college1@ds113835.mlab.com:13835/tiffin-database', autoReconnect: true })
  //store: new MongoStore({ url: 'mongodb+srv://college1:college1@cluster0-hxmeo.mongodb.net/test?retryWrites=true'})
}));

//Mongoose Connection with MongoDB
mongoose.connect('mongodb://college1:college1@ds113835.mlab.com:13835/tiffin-database');
//mongoose.connect('mongodb+srv://college1:college1@cluster0-hxmeo.mongodb.net/test?retryWrites=true');
